...
class ApplicationMediaExtension extends \Twig_Extension
{
    ...
    {
        return array(
            new \Twig_SimpleFunction('media_asset', array( $this, 'assetPath' )),
        );
    }
     ...
     * @return string
     */
    public function assetPath($media = null, $format)
    {
        $media = $this->getMedia($media);
        ...
        return $this->environment->loadTemplate('SonataMediaBundle:Provider:asset_path.html.twig')->render( array(
