 ...
 * @ORM\DiscriminatorMap({"web_refund" = "WebRefund", "credit_refund" = "CreditRefund"})
 */
class Refund
{
    /**
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Application\ShoppingBundle\Entity\Order\Order", inversedBy="refunds")
